...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_e56f073de834a377, []int{8}
}
...
func (*Filesystem) Descriptor() ([]byte, []int) {
	return fileDescriptor_e56f073de834a377, []int{9}
}
...
func (*Subvolume) Descriptor() ([]byte, []int) {
	return fileDescriptor_e56f073de834a377, []int{10}
}
...
func init() {
	...
	proto.RegisterType((*InfoResponse)(nil), "io.stellarproject.v1.InfoResponse")
...
var fileDescriptor_e56f073de834a377 = []byte{
	...
	,
}
...
func (c *infrastructureClient) Info(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/io.stellarproject.v1.Infrastructure/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Infrastructure_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/io.stellarproject.v1.Infrastructure/Info",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
